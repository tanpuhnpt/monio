...
public class RedisServiceImpl implements RedisService {
    ...
    public <T> T get(String key, Class<T> targetClass) {
        try {
            ...
            log.error("Error when reading cache with key {}: {}", key, e.getMessage());
        }
        return null;
    }
    ...
    public <T> List<T> getAll(String key, Class<T> targetClass) {
        try {
            ...
            log.error("Error when reading cache (list) with key {}: {}", key, e.getMessage());
        }
        return null;
    }
    ...
    public void save(String key, Object value) {
        try {
            ...
            log.error("Error when setting cache with key {}: {}", key, e.getMessage());
        }
    }
    ...
    public <T> void saveAll(String key, List<T> list) {
        try {
            ...
            log.error("Error when setting cache (list) with key {}: {}", key, e.getMessage());
        }
    }
