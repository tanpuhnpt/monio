package com.tanpuh.transaction.controller;
...
import com.tanpuh.transaction.service.TransactionService;
...
public class TransactionController {
    ...
    public ResponseEntity<?> getAllTransactions(
        ...
        return ResponseEntity.ok(service.getAllTransactions(type, startDate, endDate));
    }
